    ...
    <ScrollView style={styles.container}>
      ...
      <View>
        <View style={styles.tutorialCard}>
          <Image
            source={require('./images/rskincare.gif')}
      ...
      <View>
        <View style={styles.tutorialCard}>
          <Image
            source={require('./images/rmakeup.gif')}
            style={styles.tutorialImage}
          />
          <View>
            ...
            <Text style={styles.tutorialDescription}>
              Before applying makeup, ensure your skin is clean, moisturized, and protected with sunscreen. This helps your makeup go on smoothly and stay in place.
            </Text>

            <Text style={styles.routineHeader}>2. Primer (Optional)</Text>
            <Text style={styles.tutorialDescription}>
              Apply a small amount of primer (mattifying for oily skin, hydrating for dry skin) to your face after moisturizing.
            </Text>

            <Text style={styles.routineHeader}>3. Foundation or Tinted Moisturizer</Text>
            <Text style={styles.tutorialDescription}>
              Apply a small amount using your fingers, a makeup sponge, or a foundation brush. Start in the center of your face and blend outward.
            </Text>

            <Text style={styles.routineHeader}>4. Concealer</Text>
            <Text style={styles.tutorialDescription}>
              Apply a creamy concealer that’s one or two shades lighter than your skin tone under your eyes to brighten dark circles.
            </Text>

            <Text style={styles.routineHeader}>5. Blush</Text>
            <Text style={styles.tutorialDescription}>
              Choose a cream or powder blush that complements your skin tone (peachy or pink shades for lighter skin, deeper rose or berry tones for darker skin).
            </Text>

            <Text style={styles.routineHeader}>6. Eyebrows</Text>
            <Text style={styles.tutorialDescription}>
              Use a brow pencil or powder that matches your natural brow color. Lightly fill in any sparse areas using short, feathery strokes for a natural effect.
            </Text>

            <Text style={styles.routineHeader}>7. Mascara</Text>
            <Text style={styles.tutorialDescription}>
              Apply mascara to your upper lashes, wiggling the wand at the base of your lashes and sweeping it up towards the tips.
            </Text>

            <Text style={styles.routineHeader}>8. Setting Spray (Optional)</Text>
            <Text style={styles.tutorialDescription}>
              Hold the setting spray at arm’s length and lightly mist your face after finishing your makeup.
            </Text>
          </View>
        </View>
      </View>
