    ...
    <ScrollView style={styles.container}>
      ...
      <View>
        <View style={styles.tutorialCard}>
          <Image source={require('./images/oskincare.gif')} alt="Skincare Routine" style={styles.tutorialImage} />
          <View>
            ...
            <Text style={styles.tutorialDescription}>
              ...
              <Text>Morning Routine:</Text>
                ...
                <Text style={styles.tutorialDescription}>Serum (Optional, but helpful for specific concerns)</Text>
                <Text></Text>
      ...
      <View>
        <View style={styles.tutorialCard}>
          <Image source={require('./images/omakeup.gif')} alt="Skincare Routine" style={styles.tutorialImage} />
          <View>
